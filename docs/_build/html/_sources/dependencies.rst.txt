...
In the `parking-dao <https://github.com/f-o-a-m/parking-dao>`_  example project, we have zeppelin-solidity as a listed dependency. By listing this dependency, chanterelle will format the solc input so that any imports starting with ``zeppelin-solidity/`` should be fetched from ``/path/to/project/node_modules/zeppelin-solidity/``.
