...
import Chanterelle.Internal.Types.Compile (CompileError(..), CompileM(..), ContractName, OutputContract(..), SolcContract(..), SolcError(..), SolcInput(..), SolcOutput(..), SolcSettings(..), encodeOutputContract, parseSolcOutputContract, parseSolcOutput, runCompileM, runCompileMExceptT) as Compile
