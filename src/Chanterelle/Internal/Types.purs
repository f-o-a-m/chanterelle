...
import Chanterelle.Internal.Types.Artifact (Artifact(..), ArtifactBytecode(..), ArtifactBytecodeR, DeployedArtifact, NetworkInfo(..), UndeployedArtifact, _Deployed, _NetworkBytecode, _abi, _blockHash, _blockNumber, _bytecode, _code, _deployAddress, _deployedBytecode, _lastModified, _network, _networks, _transactionHash, emptyArtifactBytecode, fromSolidityContractLevelOutput) as Artifact
